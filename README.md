...
**Project:** MIPT & Yandex specialization - 6 course series.

**Platforms and tools:**  Jupyter Notebook, Python

**Description:**        This repository contains my notebooks and course projects from the MIPT & Yandex series of six courses I completed:
 1. Mathematics and Python for Data Analysis
 2. Training on Labeled Data
...
**Verify this certificate at:**       https://coursera.org/verify/specialization/MP9RPYBBYNPL

![alt text](https://github.com/dmitrii-govorukhin/Machine-Learning-and-Data-Analysis/blob/main/Machine-Learning-and-Data-Analysis-Certificate.png?raw=true)
